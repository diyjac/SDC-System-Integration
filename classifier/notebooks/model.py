...
def get_model():
 ...
 # source : https://github.com/mynameisguy/TrafficLightChallenge-DeepLearning-Nexar/blob/master/train.py

def SqueezeNet(nb_classes, inputs=(IMAGE_WIDTH, IMAGE_HEIGHT, 3)):
